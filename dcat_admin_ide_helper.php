...
namespace Dcat\Admin {
     ...
     * @property Grid\Column|Collection q_id
     ...
     * @method Grid\Column|Collection q_id(string $label = null)
     ...
     * @property Show\Field|Collection q_id
     ...
     * @method Show\Field|Collection q_id(string $label = null)
